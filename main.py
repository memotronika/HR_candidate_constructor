...
input_name = tk.Entry(window, width=24)
...
input_surname = tk.Entry(window, width=24)
...
input_passport = tk.Entry(window, width=24)
...
input_dateOfIssue = tk.Entry(window, width=24)
...
input_validTill = tk.Entry(window, width=24)
...
input_placeOfBirth = tk.Entry(window, width=24)
...
input_dateOfBirth = tk.Entry(window, width=24)
...
input_citizenship = tk.Entry(window, width=24)
...
input_companyName = tk.Entry(window, width=24)
...
input_phone = tk.Entry(window, width=24)
...
input_bankAccountNumber = tk.Entry(window, width=24)
...
input_pesel = tk.Entry(window, width=24)
...
input_cityOfLive = tk.Entry(window, width=24)
...
input_street = tk.Entry(window, width=24)
...
input_building = tk.Entry(window, width=24)
...
input_postalCode = tk.Entry(window, width=24)
...
input_client = tk.Entry(window, width=24)
...
input_role = tk.Entry(window, width=24)
...
input_salary = tk.Entry(window, width=24)
...
input_info = tk.Entry(window, width=24)
